...
class Fraction {
  ...
  public static Fraction add(Fraction f1, Fraction f2, Fraction f3) {
    int denominator = f1.denominator * f2.denominator * f3.denominator;
    int numerator = f1.numerator*f2.denominator*f3.denominator + f1.denominator*f2.numerator*f3.denominator 
    + f1.denominator*f2.denominator*f3.numerator;
    return new Fraction(numerator, denominator);
  }
  ...
  public static void main(String[] argv) {
    ...
    Fraction sumOfTwo = Fraction.add(f1, f2);              // Sum of f1 and f2.
    Fraction sumOfThree = Fraction.add(f0, f1, f2);             // Sum of f0, f1, and f2.
